...
run_turbine_validation <- function(fig_dir = "outputs/figures",
  ...
  list(
    ...
    turbine_validation_bash_window = paste(format_en_date(bash_window), collapse = " - "),
    turbine_validation_dzh_window = paste(format_en_date(dzh_window), collapse = " - "),
    turbine_validation_bash_data_start = format_en_date(bash_data_start),
    turbine_validation_dzh_data_start = format_en_date(dzh_data_start),
